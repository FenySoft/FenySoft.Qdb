    ...
    public class StorageEngineServer
    {
        ...
        private void PacketExecute(object state)
        {
            try
            {
                ...
                Descriptor responseClientDescription = new Descriptor(-1, "", StructureType.RESERVED, TDataType.Boolean, TDataType.Boolean, null, null, DateTime.Now, DateTime.Now, DateTime.Now, null);
