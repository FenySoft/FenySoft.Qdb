...
{
    public class TXTablePortable<TKey, TRecord> : ITTable<TKey, TRecord>
    {
        ...
        public TXTablePortable(ITTable<ITData, ITData> table, ITTransformer<TKey, ITData> keyTransformer = null, ITTransformer<TRecord, ITData> recordTransformer = null)
        {
            if (table == null)
