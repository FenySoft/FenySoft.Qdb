...
namespace FenySoft.Qdb.Remote.Commands
{
    public partial class CommandPersist
    {
        ...
        private FindNextCommand ReadFindNextCommand(BinaryReader reader)
        {
            ...
            return new FindNextCommand(Key, hasValue ? (KeyValuePair<ITData, ITData>?)new KeyValuePair<ITData, ITData>(key, rec) : null);
        }
        ...
        private FindAfterCommand ReadFindAfterCommand(BinaryReader reader)
        {
            ...
            return new FindAfterCommand(Key, hasValue ? (KeyValuePair<ITData, ITData>?)new KeyValuePair<ITData, ITData>(key, rec) : null);
        }
        ...
        private FindPrevCommand ReadFindPrevCommand(BinaryReader reader)
        {
            ...
            return new FindPrevCommand(Key, hasValue ? (KeyValuePair<ITData, ITData>?)new KeyValuePair<ITData, ITData>(key, rec) : null);
        }
        ...
        private FindBeforeCommand ReadFindBeforeCommand(BinaryReader reader)
        {
            ...
            return new FindBeforeCommand(Key, hasValue ? (KeyValuePair<ITData, ITData>?)new KeyValuePair<ITData, ITData>(key, rec) : null);
        }
        ...
        private FirstRowCommand ReadFirstRowCommand(BinaryReader reader)
        {
            ...
            return new FirstRowCommand(hasValue ? (KeyValuePair<ITData, ITData>?)new KeyValuePair<ITData, ITData>(key, rec) : null);
        }
        ...
        private LastRowCommand ReadLastRowCommand(BinaryReader reader)
        {
            ...
            return new LastRowCommand(hasValue ? (KeyValuePair<ITData, ITData>?)new KeyValuePair<ITData, ITData>(key, rec) : null);
        }
