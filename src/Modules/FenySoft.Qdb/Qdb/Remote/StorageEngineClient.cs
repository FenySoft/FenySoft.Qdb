...
{
    public class StorageEngineClient : ITStorageEngine
    {
        ...
        public ITTable<TKey, TRecord> OpenXTablePortable<TKey, TRecord>(string AName, TDataType AKeyDataType, TDataType ARecordDataType, ITTransformer<TKey, ITData> AKeyTransformer, ITTransformer<TRecord, ITData> ARecordTransformer)
        {
            ...
            return new XTablePortable<TKey, TRecord>(index, AKeyTransformer, ARecordTransformer);
        }

        public ITTable<ITData, ITData> OpenXTablePortable(string AName, TDataType AKeyDataType, TDataType ARecordDataType)
        {
            var cmd = new StorageEngineOpenXIndexCommand(AName, AKeyDataType, ARecordDataType);
            InternalExecute(cmd);

            var descriptor = new Descriptor(cmd.ID, AName, AKeyDataType, ARecordDataType);
        ...
        {
            InternalExecute(new StorageEngineRenameCommand(AName, ANewName));
        }
        ...
        {
            var cmd = new StorageEngineDeleteCommand(AName);
            InternalExecute(cmd);
        }

        public bool Exists(string AName)
        {
            var cmd = new StorageEngineExistsCommand(AName);
            InternalExecute(cmd);
        ...
        {
            var cmd = new StorageEngineFindByIDCommand(null, AId);
            InternalExecute(cmd);
        ...
        public CommandCollection Execute(ITDescriptor descriptor, CommandCollection commands)
        {
