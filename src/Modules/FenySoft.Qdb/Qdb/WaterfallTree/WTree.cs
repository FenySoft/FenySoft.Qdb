...
namespace FenySoft.Qdb.WaterfallTree
{
    public partial class WTree : IDisposable
    {
        ...
        private void Commit(CancellationToken cancellationToken, Locator locator = default(Locator), bool hasLocator = false, ITData fromKey = null, ITData toKey = null)
        {
            if (disposed)
                throw new ObjectDisposedException("WTree");
        ...
        protected Locator CreateLocator(string name, int structureType, TDataType keyDataType, TDataType recordDataType, Type keyType, Type recordType)
        {
