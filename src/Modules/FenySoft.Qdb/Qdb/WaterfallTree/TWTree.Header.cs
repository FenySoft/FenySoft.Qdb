namespace FenySoft.Qdb.WaterfallTree
{
    ...
    {
        private static class TSettings
        {
            public static void Serialize(TWTree tree, Stream stream)
            {
            ...
            public static void Deserialize(TWTree tree, Stream stream)
            {
                ...
                switch (version)
                {
                    ...
                    default:
                        throw new NotSupportedException("Unknown TWTree header version.");
                }
            }
        }         
    }
