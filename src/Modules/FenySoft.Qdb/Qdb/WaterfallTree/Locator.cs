...
{
    public class Locator : ITDescriptor, IComparable<Locator>, IEquatable<Locator>
    {
        ...
        static Locator()
        {
            MIN = new Locator(0, null, Database.StructureType.RESERVED, TDataType.Boolean, TDataType.Boolean, null, null);
        ...
        public Locator(long id, string name, int structureType, TDataType keyDataType, TDataType recordDataType, Type keyType, Type recordType)
        {
            ...
            {
                case Database.StructureType.XTABLE: Apply = new XTableApply(this); break;
                case Database.StructureType.XFILE:  Apply = new XStreamApply(this); break;
            }
